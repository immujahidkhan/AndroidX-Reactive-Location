...
import com.android.locationlibrary.ReactiveLocationProvider;
import com.android.locationlibrary.ReactiveLocationProviderConfiguration;
import com.android_reactive_location_sample.utils.AddressToStringFunc;
import com.android_reactive_location_sample.utils.DetectedActivityToString;
import com.android_reactive_location_sample.utils.DisplayTextOnViewAction;
import com.android_reactive_location_sample.utils.LocationToStringFunc;
import com.android_reactive_location_sample.utils.ToMostProbableActivity;
...
import static com.android_reactive_location_sample.utils.UnsubscribeIfPresent.dispose;
...
public class MainActivity extends BaseActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add("Places").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                if (TextUtils.isEmpty(getString(R.string.google_maps_key))) {
